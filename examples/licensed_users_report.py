...
FILE_PATH = "ppa_licensed_users.csv"
...
def main() -> None:
    ...
    with open(FILE_PATH, "w") as csv_file:
        ...
        list(
            map(
                lambda u: csv_writer.writerow([u.name, u.email, u.authenticated_at]),
                ppa.licensed_users(),
            )
        )
    print(f"Licensed users spreadsheet was written to {FILE_PATH}.")
